...
<template>
    <div
        class="bg-gray-800 w-[6rem] h-[100vh] fixed top-[0px] pt-[64px] z-[10] shadow-md"
    >
        <button
        ...
        >
            <svg
                class="pt-4 h-[10vmin] text-gray-800 dark:text-white"
            ...
            <a class="text-[1.5vmin] text-white">Template</a>
        </button>
        <!--Select Demo-->
        <button
            @click="showMenu('demo')"
        ...
        >
            <svg
                ...
                class="pt-4 w-8 h-[10vmin] text-gray-800 dark:text-white"
                fill="white"
        ...
        >
            <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
                style="width: 100%; max-width: 50px; margin: auto"
                class="pt-4 w-9 h-[10vmin] text-gray-800 dark:text-white"
                fill="white"
                viewBox="0 0 122.88 122.88"
            >
                <path
        ...
        <!--Setup Grid-->
        <button
            @click="showMenu('setupgrid')"
            :class="{ 'bg-[gray]': activeMenu == 'setupgrid' }"
            type="button"
            style="width: 100%"
            class="hover:bg-orange-700"
        >
            <svg
                ...
                class="pt-4 w-11 h-[10vmin] text-gray-800 dark:text-white"
                fill="white"
                x="0px"
                y="0px"
