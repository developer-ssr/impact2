...
import Analysis_Component from "@/Components/AnalysisComponent/index.vue";
const template_visible = ref(false);
const toggle_analysis = ref(false);
const gridtools_display = ref(true);
...
onMounted(() => {
    document
        .querySelector("#selected_trial")
        .addEventListener("display_analysis", (event) => {
            gridtools_display.value = !gridtools_display.value;
            if (gridtools_display.value == true) {
                toggle_analysis.value = false;
            } else {
                toggle_analysis.value = true;
            }
            console.log(toggle_analysis.value);
        });
});
</script>
...
<template>
    ...
    >
        ...
        <button
            ...
            type="button"
            style="width: 100%"
            class="hover:bg-orange-700 pl-6 pt-6"
        >
            <svg
                width="50px"
                height="64px"
                ...
                fill="#ffffff"
                stroke="#ffffff"
                stroke-width="1.6919999999999997"
            >
            ...
            <a class="text-sm text-white text-[1.5vmin] pr-6">Grid</a>
        </button>
        <!--Redirect-->
        <button
    ...
    >
        <gridTools v-if="gridtools_display" />

        <div class="bg-white w-full h-full shadow-md z-2 relative">
            <gridBody v-if="gridtools_display" />
            <Analysis_Component v-if="toggle_analysis" />
        </div>
    </div>
</template>
<style type="text/css">
