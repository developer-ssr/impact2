...
import Grid_Editor from "@/Components/EngineComponent/grid_editor.vue";
...
<!--Templates-->
    ...
    <button @click="showMenu('templates')" :class="{'bg-[gray]':(activeMenu == 'templates')}" type="button" style="width: 100%" class= "hover:bg-orange-700 ">
        <svg class="pt-4 h-[10vmin] text-gray-800 dark:text-white" style="width: 100%; max-width: 60px; margin: auto;" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" viewBox="0 0 24 24">
        ...
        <a class="text-sm text-white text-[2vmin]">Template</a>
    </button>
<!--Select Demo-->
    <button @click="showMenu('demo')" :class="{'bg-[gray]':(activeMenu == 'demo')}" type="button" style="width: 100%" class= "hover:bg-orange-700 ">
        <svg class="pt-4 w-10 h-[10vmin] text-gray-800 dark:text-white" style="width: 100%; max-width: 60px; margin: auto;" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" viewBox="0 0 24 24">
            <path fill-rule="evenodd" d="M2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10S2 17.523 2 12Zm11-4.243a1 1 0 1 0-2 0V11H7.757a1 1 0 1 0 0 2H11v3.243a1 1 0 1 0 2 0V13h3.243a1 1 0 1 0 0-2H13V7.757Z" clip-rule="evenodd"/>
        </svg>
        <a class="text-sm text-white text-[2vmin]">Select Demo</a>
    </button>
<!--Trials-->
    <button @click="showMenu('trial')" :class="{'bg-[gray]':(activeMenu == 'tiral')}" type="button" style="width: 100%" class= "hover:bg-orange-700 ">
        <svg xmlns="http://www.w3.org/2000/svg" style="width: 100%; max-width: 50px; margin: auto;" class="pt-4 w-8 h-[10vmin] text-gray-800 dark:text-white" fill="white" viewBox="0 0 122.88 122.88">
        ...
        <a class="text-md text-white text-[2vmin]">Trial</a>
    </button>
<!--Redirect-->
    <button @click="showMenu('redirect')" :class="{'bg-[gray]':(activeMenu == 'redirect')}" type="button" style="width: 100%" class= "hover:bg-orange-700 ">
        <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" style="width: 100%; max-width: 50px; margin: auto;" class="pt-4 w-9  h-[10vmin] text-gray-800 dark:text-white" fill="white" viewBox="0 0 122.88 122.88">
...
<!--Setup Grid-->
    <button @click="showMenu('setupgrid')" :class="{'bg-[gray]':(activeMenu == 'setupgrid')}" type="button" style="width: 100%" class= "hover:bg-orange-700 ">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="width: 100%; max-width: 55px; margin: auto;" class="pt-4 w-11  h-[10vmin] text-gray-800 dark:text-white" fill="white" x="0px" y="0px" viewBox="0 0 122.88 112.43">
        ...
        <a class="text-sm text-white text-[2vmin]">Setup Grid</a>
    </button>
<!--Instructions-->
        ...
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 122.88 122.88" style="width: 100%; max-width: 55px; margin: auto;" class="pt-4 w-11  h-[10vmin] text-gray-800 dark:text-white" fill="white"><g>
        ...
        <a class="text-sm text-white text-[2vmin]">Instructions</a>
        </button>
    </div>
    <div
        class="relative maincon w-full pl-[6rem] flex flex-col gap-1 grow-[1] h-[calc(100vh-5rem)]"
    >
        <div class="relative bg-white grow-2 h-14 shadow-md z-1">
            <div class="float-end p-5 flex flex-row">
                <svg
        ...
        <div class="bg-white w-full h-full shadow-md z-2 relative">
            <Grid_Editor />
        </div>
    </div>
</template>
