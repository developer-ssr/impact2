...
<!--Select Demo-->
    <button @click="showMenu('demo')" :class="{'bg-[gray]':(activeMenu == 'demo')}" type="button" style="width: 100%" class= "hover:bg-yellow-700 ">
...
<!--Trials-->
    <button @click="showMenu('trial')" :class="{'bg-[gray]':(activeMenu == 'tiral')}" type="button" style="width: 100%" class= "hover:bg-red-700 ">
...
<!--Redirect-->
    <button @click="showMenu('redirect')" :class="{'bg-[gray]':(activeMenu == 'redirect')}" type="button" style="width: 100%" class= "hover:bg-blue-700 ">
...
<!--Setup Grid-->
    <button @click="showMenu('setupgrid')" :class="{'bg-[gray]':(activeMenu == 'setupgrid')}" type="button" style="width: 100%" class= "hover:bg-yellow-400 ">
...
<!--Instructions-->
        <button @click="showMenu('instructions')" :class="{'bg-[gray]':(activeMenu == 'instructions')}" type="button" style="width: 100%" class= "hover:bg-orange-900 ">
